...
import { apiGetOrganizationalUnitEmployeesDiscount } from 'services/AdministrationService'
...
export const setEmployeesList = createAsyncThunk('attendance/state/setEmployeesList', async (data) =>  await apiGetOrganizationalUnitEmployeesDiscount(data) )
