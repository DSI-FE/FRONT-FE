...
const Filters = ({children}) => {
    ...
    const isRRHH = functionalPosition.id === 48 || functionalPosition.id === 47 || functionalPosition.id === 89
    ...
    },[dispatch,organizationalUnit,orgId,dateIni,dateEnd,showNoLaboralDays ])
