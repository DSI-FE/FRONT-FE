...
export const getEntriesIndexWithFilesByType = createAsyncThunk('settingsGallery/data/getEntriesIndexWithFilesByType', async (type) =>  await apiGetEntriesIndexWithFilesByType(type) )

const dataSlice = createSlice(
{
    name: 'settingsGallery/data',
    initialState: {
        loading:false,
        entries:[]
    },
