...
export const getEntriesIndexWithFilesByType = createAsyncThunk('settingsMagazine/data/getEntriesIndexWithFilesByType', async (type) =>  await apiGetEntriesIndexWithFilesByType(type) )

const dataSlice = createSlice(
{
    name: 'settingsMagazine/data',
    initialState: {
        loading:false,
        entries:[]
    },
