...
export const getEntriesIndexWithFilesByType = createAsyncThunk('magazine/data/getEntriesIndexWithFilesByType', async (type) =>  await apiGetEntriesIndexWithFilesByType(type) )
