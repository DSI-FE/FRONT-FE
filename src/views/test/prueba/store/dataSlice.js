...
export const getEntriesIndexWithFilesByType = createAsyncThunk('gallery/data/getEntriesIndexWithFilesByType', async (type) =>  await apiGetEntriesIndexWithFilesByType(type) )
