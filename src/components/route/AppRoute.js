...
const OptionsMenu = ({options,index,functionalPosition}) =>
{
    ...
    const isRRHH = functionalPosition.id === 48 || functionalPosition.id === 89 ? true : false;
        ...
        return ( base ?
            <div>
                ...
                >
                    ...
                    {
                        base.options && base.options.length > 1 ? <OptionsMenu options={base.options} index={index} functionalPosition={functionalPosition}/> : <span></span>
                    }
                    </div>
                </div>
                <div className={`w-full ${padding}`}>
                {
                    base.subOptions ? <SubOptionsMenu options={base.subOptions} index={subIndex} functionalPosition={functionalPosition}/> : <span></span>
                }
                </div>
            </div>
            :
